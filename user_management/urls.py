...
from .views import UserViewSet, UserProfileViewSet, CustomLoginView
...
urlpatterns = [
#    path('api1/auth/', CustomLoginView.as_view(), name='custom_login'),
    path('api1/login/', CustomLoginView.as_view(), name='custom_login'),
